...
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
    ...
    <style>
        ...
        .detail1 span{ font-size: 17px; color: green; margin-left:-50px; }

        .price1{ margin-top: 5px; color: black;  width:120px; display:flex; }
        ...
        .buynow-layer1{ width: 100%; height: 100%; position: absolute; left: 50%; right: 50%; transform: translate(-50%, -100%); background-color: rgba( 92, 95, 236, 0.6 ); justify-content: center; align-items: center; visibility: hidden; padding-top: 100px; padding-left: 0px;}
        ...
        .buynow-layer{ width: 100%; height: 100%; position: absolute; left: 50%; right: 50%; transform: translate(-50%, -100%); background-color: rgba( 92, 95, 236, 0.6 ); justify-content: center; align-items: center; visibility: hidden; padding-top: 40%; padding-left: 0%; }        
        .buynow-layer .btn{ width: 50%;}
        ...
        .price{ margin-top: 5px; color: black;  width:80px; display:flex; }
        .price span{ font-size: 12px;  color: rgba(26,26,26,0.5); margin-right:10px; margin-Top:0px; font-weight: bold; color:red}
        .price h4{ color: #222222; margin: 0x 0px; font-size: 15px; font-weight: bold; letter-spacing: 0.2px; padding-right: 5px; }
    ...
    <div class="main">
        ...
        <div class="name-bar">
            <div class="name-mid">
                <div class="site-name">
                    ...
                    <div class="name-1"><a href="Home.php"><h1>ALLINONE.</h1></a></div>
        ...
        <div class="site-page">
            ...
            <div class="navigation">
                ...
                if(isset($_SESSION['email']))
                {
                    echo '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Post Ad</button>';     
                }
                else
                {
                    echo '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModa2">Post Ad</button>';    
                }
                ?>
                    ...
                    <div class="main-slide">
                        <div class="main">
                            <div class="swiper mainSwiper">
                                ...
                                <div class="swiper-slide"><img src="Image/1.jpg" alt=""></div>
                                <div class="swiper-slide"><img src="Image/2.jpg" alt=""></div>
        ...
        <div class="pro-slider-1">
            ...
            <div class="swiper mySwiper1">
                ...
                <?php                     
                        ...
                        $sql_2 = "SELECT * FROM product  WHERE Category_Id  = '1' ";	
        ...
        <div class="pro-slider-1">
            ...
            <div class="swiper mySwiper">
                ...
                <?php                     
                        ...
                        $sql_2 = "SELECT * FROM product  WHERE Category_Id  = '2' ";	
                        $result_2 = mysqli_query($conn, $sql_2);	
                    ...
                    <div class="modal-body">            
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="Number" class="form-control" name="Te_Number"   id="Te_Number"   placeholder="Telephone Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10"><br/>  

                                <input type="Number" class="form-control" name="AccountNo"   id="AccountNo"   placeholder="Bank Account Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" ><br/>
        ...
        <?php 	
	        ...
	        {	
		        ...
		        if($productName == "" || $Te_Number == "" || $description == "" || $Price == "" || $Quantity == "" || $AccountNo == "" )
                {
                    ...
                    $sql_1 = "INSERT INTO product( PName, Tell_no, Description, Price, Category_Id, SubCategory_Id, Type, image, Uid, order_type, Quantity, AccountNo) VALUES('$productName','$Te_Number','$description','$Price','$category_Id','$Subcategory_id', '$Type', '$url', '$Id', '$ordertype', '$Quantity', '$AccountNo' )";	
        ...
        <!---------------------------------------- Start Not Login post ad Modal -------------------------------------------------> 

        <div class="modal fade" id="exampleModa2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Loging Now</h5>
                        <button button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">            
                        ...
                        <a href="Login.php" class="btn btn-primary" style=" width: 100%; margin-bottom: 20px;">Login Now</a>
                        <a href="Signup.php" class="btn btn-primary" style=" width: 100%; margin-bottom: 20px;">Signup Now</a>                  
                        
                    </div>          
                </div>
            </div>
        </div>       
        <!---------------------------------------- End Not Login post ad Modal -------------------------------------------------> 
